...
public class CtuConstidClient {
    ...
    private String url; // Device fingerprint service domain name
     ...
     *
     * @param token Device fingerprint token
     * @return
     * @throws IOException
     */
    ...
    /**
     * Situational awareness data decryption
     *
     * @param sid          businessDigest
     * @param businessSign
     * @param data
     * @return
     * @throws IOException
