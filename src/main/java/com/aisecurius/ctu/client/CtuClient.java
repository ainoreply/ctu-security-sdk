...
import com.aisecurius.ctu.client.model.*;
import com.aisecurius.ctu.client.util.HttpClientPool;
import com.aisecurius.ctu.client.util.InputStreamUtils;
import com.aisecurius.ctu.client.util.SignUtil;
...
public class CtuClient {
    private String url; // Risk prevention and control service URL
    private String appKey; // issued public key
    private String appSecret; // The issued secret key is strictly prohibited to be disclosed, please keep it safe, and do not disclose it!
